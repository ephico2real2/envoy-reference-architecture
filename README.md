...
- `grpc.eg-poc2.poc.local` resolves to `172.19.255.151` (DNS or `/etc/hosts`) â see step 4.
- An internal CA, or cert-manager on the cluster, to issue the gateway certificate â see step 5.
